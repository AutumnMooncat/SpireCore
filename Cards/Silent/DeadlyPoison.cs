...
internal sealed class DeadlyPoison : Card, IRCard
{
    public static string ID => nameof(DeadlyPoison);
        ...
        switch (upgrade)
        {
            case Upgrade.None:
                ...
                [
                    new AStatus()
                    {
                        status = MainModFile.Instance.KokoroApi.V2.OxidationStatus.Status,
                        statusAmount = 3,
                        targetPlayer = false
                    }
                ];
